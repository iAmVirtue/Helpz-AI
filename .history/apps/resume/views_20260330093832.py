...
from .services import extract_text_from_pdf, analyze_resume
...
def generate_explore_graph(request):
    """Generate knowledge graph for explore feature"""
    if request.method == "POST":
        try:
            ...
            for model_name in models_to_try:
                try:
                    ...
                    # Clean the text in case Gemini wrapped it in markdown
...
def explore(request):
    ...
    return render(request, "resume/explore.html")
